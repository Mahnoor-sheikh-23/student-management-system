...
addstudent(name:string,fname:string,age:number,classe:number):void{
...
enrolstudent(studentid:string , courseid:string):void{
...
payTutionFee(studentID:string,amount:number):void{
    const sTUDent : any = this.student.find(p=>p.id === studentID) //checking  to id 
...
function addstudents(){
     ...
     }]).then(answer=>{//here we call our class which is sim and in our class there is a method which is addstudent 
